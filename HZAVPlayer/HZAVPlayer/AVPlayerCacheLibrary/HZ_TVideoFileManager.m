...
@implementation HZ_TVideoFileManager
{
...
- (instancetype)initWithFileName:(NSString*)fileName
{
   ...
   NSString * path = [HZ_TVideoFileManager creatCacheDirectory];
...
{
    NSString * path = [HZ_TVideoFileManager cacheFolderPath];
...
+ (NSString*)creatCacheDirectory{
    ...
    NSFileManager * manager = [NSFileManager defaultManager];
    NSString * cacheFolderPath = [HZ_TVideoFileManager cacheFolderPath];
...
+ (BOOL)clearCache {
    NSFileManager * manager = [NSFileManager defaultManager];
    return [manager removeItemAtPath:[HZ_TVideoFileManager cacheFolderPath] error:nil];
}
